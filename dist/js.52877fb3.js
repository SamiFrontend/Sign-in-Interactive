...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/MethodsMain.ts":[function(require,module,exports) {
"use strict";
...
__export(require("./index")); // all inputs 


function validInput(parentInput, InputHasValid) {
  var checkForNameInput = InputHasValid.name;
  var massege;
...
exports.validInput = validInput; // function cerate Tag of text 

function createTag(msg) {
  var elm = document.createElement('small');
  elm.className = "error-msg size-5";
  elm.innerText = msg;
  return elm;
}
},{"./index":"js/index.ts"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
var Moduling = __importStar(require("./MethodsMain"));

var gsap_1 = require("gsap");

var ScrollTrigger_1 = require("gsap/ScrollTrigger"); // configration about scroll Trigger 


gsap_1.gsap.registerPlugin(ScrollTrigger_1.ScrollTrigger); // shortcut $ using same jQuery 
...
var Main = new Cycle(); // all Element usign in DOM 
// btn show password 

$(DOM.showPass).addEventListener('click', function () {
  this.classList.toggle('active');

  if (this.classList.contains('active')) {
    // dontLook 
    dontLook(); // change Type password 
...
var btnSign = $(DOM.signIn); // Main Function Proccesing all Data Here 

function proccessData() {
  'use strict'; // make array of input in form 

  var Inputs = [$(DOM.email), $(DOM.password)];
...
function checkForInputs(InputCheck) {
  for (var _i = 0, InputCheck_1 = InputCheck; _i < InputCheck_1.length; _i++) {
    var valid = InputCheck_1[_i]; // parent Input save in array 

    var parentValid = valid.name === "password" ? valid.parentElement.parentNode : valid.parentElement;
    ...
    if (parentValid.classList.contains('valid-input')) {
      return false;
    }
...
btnSign.addEventListener('click', proccessData); // Func Animation 
...
function eyeball(event) {
  ...
  Eyes.forEach(function (element) {
    ...
    var radian = Math.atan2(event.pageX - x, event.pageY - y); //   rot is a variable (short for rotate)
...
function informationIsTrue() {
  ...
  var success = gsap_1.gsap.timeline({
    defaults: {
      duration: 1
    }
  });
...
var falseTimer = gsap_1.gsap.timeline({
  defaults: {
    duration: 1
  }
});
...
},{"./MethodsMain":"js/MethodsMain.ts","gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
